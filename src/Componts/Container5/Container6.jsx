...
const Container6 = () => {
    ...
    return (
        <div className=' bg-black h-[110vh] border-y-8 border-gray-800  pt-[4.7rem] flex justify-center'>
            <div className=''>
                ...
                <div onClick={() => plusVisibility(1)} className='border border-none h-[8vh] w-[65vw] mr-5 bg-neutral-800 mt-4 flex justify-between items-center'>
                ...
                <div onClick={() => plusVisibility(2)} className='border border-none h-[8vh] w-[65vw] mr-5 bg-neutral-800 mt-4 flex justify-between items-center'>
                ...
                <div onClick={() => plusVisibility(3)} className='border border-none h-[8vh] w-[65vw] mr-5 bg-neutral-800 mt-4 flex justify-between items-center'>
                ...
                <div onClick={() => plusVisibility(4)} className='border border-none h-[8vh] w-[65vw] mr-5 bg-neutral-800 mt-4 flex justify-between items-center'>
                ...
                <div onClick={() => plusVisibility(5)} className='border border-none h-[8vh] w-[65vw] mr-5 bg-neutral-800 mt-4 flex justify-between items-center'>
